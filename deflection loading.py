...
if face:
    print >> sys.__stdout__, "\t"+"Found Center Face..." 
else:
    print >> sys.__stdout__, "\t"+"Cant Find Center Face..."
# Genereate MPC TIE
point = (160, 105, -0.5)
point2 = (180, 128, 6.5)
x_min = min(point[0], point2[0])
...
face = mdb.models[MODEL_NAME].rootAssembly.instances[PART_NAME+'-1'].faces.getByBoundingBox(x_min, y_min, z_min ,x_max, y_max, z_max)
if face:
    print >> sys.__stdout__, "\t"+"Found Left Face..." 
else:
    print >> sys.__stdout__, "\t"+"Cant Find Left Face..."

mdb.models[MODEL_NAME].rootAssembly.Set(faces=face, name='Inner left')

mdb.models[MODEL_NAME].DisplacementBC(name='Fixed left', 
    createStepName='Loading down with g', region=mdb.models[MODEL_NAME].rootAssembly.sets['Inner left'], 
    u1=0.0, u2=0.0, 
    u3=0.0, ur1=0.0, ur2=0.0, ur3=UNSET, amplitude=UNSET, fixed=OFF, 
...
face = mdb.models[MODEL_NAME].rootAssembly.instances[PART_NAME+'-1'].faces.getByBoundingBox(x_min, y_min, z_min ,x_max, y_max, z_max)
if face:
    print >> sys.__stdout__, "\t"+"Found Right Face..." 
else:
    print >> sys.__stdout__, "\t"+"Cant Find Right Face..."


mdb.models[MODEL_NAME].rootAssembly.Set(faces=face, name='Inner right')
# NEW BC
mdb.models[MODEL_NAME].DisplacementBC(name='Inner right', 
    createStepName='Loading down with g', region=mdb.models[MODEL_NAME].rootAssembly.sets['Inner right'], 
    u1=UNSET, u2=0.0, 
    u3=0.0, ur1=0.0, ur2=0.0, ur3=UNSET, amplitude=UNSET, fixed=OFF, 
    distributionType=UNIFORM, fieldName='', localCsys=None)
# mdb.models[MODEL_NAME].DisplacementBC(
#     createStepName='Loading down with g', region=mdb.models[MODEL_NAME].rootAssembly.sets['Inner right'], u1=UNSET, u2=0.0, 
#     u3=UNSET, ur1=0.0, ur2=0.0, ur3=UNSET, amplitude=UNSET, fixed=OFF, 
#     distributionType=UNIFORM, fieldName='', localCsys=None)
# print("HERE")
# OLD BC
# mdb.models[MODEL_NAME].PinnedBC(createStepName='Loading down with g', localCsys=
...
mdb.models[MODEL_NAME].ConcentratedForce(cf1=100, createStepName=
    'Loading down with g', distributionType=UNIFORM, field='', localCsys=None, 
    name='In Plane', region=
    mdb.models[MODEL_NAME].rootAssembly.sets['Loading point'])
mdb.models[MODEL_NAME].ConcentratedForce(cf3=100, createStepName=
    'Loading down with g', distributionType=UNIFORM, field='', localCsys=None, 
    name='Out Plane', region=
    mdb.models[MODEL_NAME].rootAssembly.sets['Loading point'])
