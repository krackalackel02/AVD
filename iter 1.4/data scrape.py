...
current = os.getcwd()
path = os.path.join(current, "texts",relative_path+"_Stresses everywhere.txt")
# Example usage:
# print(path)
file_name = path  # Replace with your file path
STRESS.append(find_max_stress(file_name))
current = os.getcwd()
path = os.path.join(current, "texts",relative_path+"_deflection centreline.txt")
# Example usage:
file_name = path  # Replace with your file path
DEFLECTION.append(find_deflections(file_name))
current = os.getcwd()
path = os.path.join(current, "texts",relative_path+"_Buckle Load.txt")
# Example usage:
file_name = path  # Replace with your file path
