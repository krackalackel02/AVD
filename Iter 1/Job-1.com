...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'Pauls-Desktop',
    'listener_resource':'27892',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('pauls-desktop', '129.31.229.200', 'pauls-desktop.cust.communityfibre.co.uk', '192.168.1.130'),
    'mp_host_list':(('pauls-desktop', 8),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l paulk -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\paulk\\AppData\\Local\\Temp',
    'tracer':OFF,
